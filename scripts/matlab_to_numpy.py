...
np.save(os.path.join(args.path, 'patient_ids.npy'), patient_ids)
np.save(os.path.join(args.path, 'file_paths.npy'), file_paths)

print('labels.npy, images.npy, masks.npy, patient_ids saved in', args.path)
